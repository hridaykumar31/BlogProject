  ...
  <div class="container">
      <nav class="navbar navbar-expand-lg navbar-white">
          <a class="order-1 navbar-brand" href="{{ url('/') }}">
              <img class="img-fluid" width="120px" src="{{ asset('usr_assets/images/logo1.jpg') }}"
                  alt="Reader | Blog">
          </a>
          <div class="order-3 text-center collapse navbar-collapse order-lg-2" id="navigation">
              <ul class="mx-auto navbar-nav">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="{{route('questions')}}">Q&A</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('payment')}}">premium</a>
                </li>
              </ul>
          </div>
